...
function UPCP_Add_Back_To_Catalogue_Link() {
	...
	echo "<a class='upcp-catalogue-link' href='" . esc_attr( esc_url_raw( $_POST['current_url'] ) ) . "'>&#171; " . $Back_To_Catalogue_Label . "</a>";

	$HeaderBar = "<form id='upcp-hidden-filtering-form' method='post' target='" . $Target . "'>";
	$HeaderBar .= "<input type='hidden' id='upcp-selected-categories' name='categories' value='" . esc_attr( sanitize_text_field( $_POST['categories'] ) ) . "' />";
	$HeaderBar .= "<input type='hidden' id='upcp-selected-subcategories' name='sub-categories' value='" . esc_attr( sanitize_text_field( $_POST['sub-categories'] ) ) . "' />";
	$HeaderBar .= "<input type='hidden' id='upcp-selected-tags' name='tags' value='" . esc_attr( sanitize_text_field( $_POST['tags'] ) ) . "' />";
	$HeaderBar .= "<input type='hidden' id='upcp-selected-prod-name' name='prod_name' value='" . esc_attr( sanitize_text_field( $_POST['prod_name'] ) ) . "' />";
	$HeaderBar .= "<input type='hidden' id='upcp-selected-current-page' name='current_page' value='" . esc_attr( esc_url_raw( $_POST['current_page'] ) ) . "' />";
