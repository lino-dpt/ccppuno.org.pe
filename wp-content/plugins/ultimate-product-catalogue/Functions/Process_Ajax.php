...
function UPCP_Filter_Catalogue() {
	...
	$default_search_text = isset( $_POST['default_search_text'] ) ? sanitize_text_field($_POST['default_search_text']) : '';
	...
	$Prod_Name = ( sanitize_text_field($_POST['Prod_Name']) != $default_search_text and $_POST['Prod_Name'] != "" ) ? sanitize_text_field($_POST['Prod_Name']) : '';
